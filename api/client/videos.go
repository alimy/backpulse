...
func (c *Client) GetVideoGroups(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	name := vars["name"]
...
func (c *Client) GetVideoGroup(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	id := vars["short_id"]
...
func (c *Client) GetVideo(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	id := vars["id"]
