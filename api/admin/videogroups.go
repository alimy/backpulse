...
// VideoGroups indicator videoGroups handler
type VideoGroups struct {
	group                    mir.Group  `mir:"admin"`
	updateVideoGroupsIndexes mir.Put    `mir:"/videogroups/{name}/indexes"`
	createVideoGroup         mir.Post   `mir:"/videogroups/{name}"`
	getVideoGroups           mir.Get    `mir:"/videogroups/{name}"`
	getVideoGroup            mir.Get    `mir:"/videogroups/{name}/{id}"`
	updateVideoGroup         mir.Put    `mir:"/videogroups/{name}/{id}"`
	deleteVideoGroup         mir.Delete `mir:"/videogroups/{name}/{id}"`
}

func (v *VideoGroups) CreateVideoGroup(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	name := vars["name"]
...
func (v *VideoGroups) GetVideoGroups(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	name := vars["name"]
...
func (v *VideoGroups) GetVideoGroup(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	name := vars["name"]
	id := vars["id"]
...
func (v *VideoGroups) DeleteVideoGroup(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	name := vars["name"]
	id := vars["id"]
...
func (v *VideoGroups) UpdateVideoGroup(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	siteName := vars["name"]
	id := vars["id"]
...
func (v *VideoGroups) UpdateVideoGroupsIndexes(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	siteName := vars["name"]
