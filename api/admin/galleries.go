...
// Galleries indicator galleries handler
type Galleries struct {
	group                  mir.Group  `mir:"admin"`
	getGallery             mir.Get    `mir:"/gallery/{id}"`
	deleteGallery          mir.Delete `mir:"/gallery/{id}"`
	updateGallery          mir.Put    `mir:"/gallery/{id}"`
	setGalleryPreview      mir.Put    `mir:"/galleries/{name}/{galleryID}/preview/{id}"`
	setDefaultGallery      mir.Put    `mir:"/galleries/{name}/default/{id}"`
	updateGalleriesIndexes mir.Put    `mir:"/galleries/{name}/indexes"`
	createGallery          mir.Post   `mir:"/galleries/{name}/{galleryName}"`
	getGalleries           mir.Get    `mir:"/galleries/{name}"`
}

// DeleteGallery handler
func (g *Galleries) DeleteGallery(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	id := vars["id"]
...
func (g *Galleries) GetGalleries(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	name := vars["name"]
...
func (g *Galleries) SetGalleryPreview(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	siteName := vars["name"]
...
func (g *Galleries) SetDefaultGallery(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	siteName := vars["name"]
	galleryID := vars["id"]
...
func (g *Galleries) UpdateGallery(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	id := vars["id"]
...
func (g *Galleries) CreateGallery(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	siteName := vars["name"]
...
func (g *Galleries) UpdateGalleriesIndexes(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	siteName := vars["name"]
