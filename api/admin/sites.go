...
// Sites indicator sites handler
type Sites struct {
	group              mir.Group  `mir:"admin"`
	getSites           mir.Get    `mir:"/sites"`
	getOverview        mir.Get    `mir:"/sites/{name}/overview"`
	getSite            mir.Get    `mir:"/sites/{name}"`
	updateSite         mir.Put    `mir:"/sites/{name}"`
	deleteSite         mir.Delete `mir:"/sites/{name}"`
	createSite         mir.Post   `mir:"/sites"`
	favorite           mir.Put    `mir:"/sites/favorite/{name}"`
	addModule          mir.Post   `mir:"/sites/{name}/modules/{module}"`
	removeModule       mir.Delete `mir:"/sites/{name}/modules/{module}"`
	getSiteModules     mir.Get    `mir:"/sites/{name}/modules"`
	getCollaborators   mir.Get    `mir:"/sites/{name}/collaborators"`
	addCollaborator    mir.Post   `mir:"/sites/{name}/collaborators/{email}"`
	removeCollaborator mir.Delete `mir:"/sites/{name}/collaborators/{email}"`
	transferSite       mir.Post   `mir:"/sites/{name}/transfer/{email}"`
}

// GetSites : return list of sites for a given user
func (s *Sites) GetSites(w http.ResponseWriter, r *http.Request) {
...
func (s *Sites) GetOverview(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	name := vars["name"]
...
func (s *Sites) GetSite(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	name := vars["name"]
...
func (s *Sites) RemoveModule(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	name := vars["name"]
...
func (s *Sites) AddModule(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	name := vars["name"]
	moduleName := vars["module"]
	log.Println(moduleName)
...
func (s *Sites) GetSiteModules(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	name := vars["name"]
...
func (s *Sites) Favorite(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	name := vars["name"]
...
func (s *Sites) DeleteSite(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	name := vars["name"]
	id := utils.GetUserObjectID(r)
	site, _ := database.GetSiteByName(name)
...
func (s *Sites) GetCollaborators(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	name := vars["name"]
...
func (s *Sites) AddCollaborator(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	name := vars["name"]
	email := vars["email"]
...
func (s *Sites) TransferSite(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	name := vars["name"]
	email := vars["email"]
...
func (s *Sites) RemoveCollaborator(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	name := vars["name"]
	email := vars["email"]
...
func (s *Sites) UpdateSite(w http.ResponseWriter, r *http.Request) {
